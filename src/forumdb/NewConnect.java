...
//            java.util.logging.Logger.getLogger(NewConnect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                NewConnect dialog = new NewConnect(new javax.swing.JFrame(), true);
